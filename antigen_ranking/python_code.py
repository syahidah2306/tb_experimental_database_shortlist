...
fasta_file_path = './Data/test_20_mtb_protein_seq.fasta'
#epitope_data = pd.read_excel('./Data/epitope_score_20240819_7criteria,inc_uniq_mtb, bce,-locus.xlsx')
epitope_data = pd.read_excel( "./Data/epitope_score_20240819_7criteria,inc_uniq_mtb, bce,-locus.xlsx",engine='openpyxl')
